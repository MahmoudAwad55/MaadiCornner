...
<a class="text-uppercase text-decoration-none brand text-white" href="index.html">MaadiCorner</a>

<p class="text-white text-muted mt-3">MaadiCorner is a newly growing online shop based on dhaka city.
