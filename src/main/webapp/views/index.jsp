    ...
    <nav class="navbar navbar-expand-lg bg-light py-2 fixed-top">
        <div class="container">
            <a class="navbar-brand d-flex justify-content-between align-items-center order-lg-0" href="#collection">
                <span class="text-uppercase fw-bold text-primary">MaadiCorner</span>
            </a>
               ...
               <form action="data" method="post">
                      ...
                      <input type="hidden" readonly="readonly" class="form-control border border-success" name="categoryid"  value="<%= rs.getInt(4) %>">
                        ...
                        <div class="text-start">
                            ...
                            <div>
                                <h2 class="price-tag text-primary fw-bold m-0"><%= rs.getInt(6) %> EGP</h2>
                             </div>   
        ...
        <div class="container">
            <div class="row ">
                <div class="col-lg-6 order-lg-1 text-center text-lg-start" data-aos="fade-left">
                    ...
                    <p class="mt-5 lead text-muted">Maadi Corner is a newly growing online shop based on dhaka city.</p>
                ...
                <div class="col-lg-6 order-lg-0" data-aos="fade-right">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3358.2816600863734!2d31.25162886225289!3d29.95968829409984!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x145847efb305d439%3A0x7b99c3a86f98ca43!2z2KPZg9in2K_ZitmF2YrYqSDYp9mE2LPYp9iv2KfYqiDZhNmE2LnZhNmI2YUg2KfZhNil2K_Yp9ix2YrYqQ!5e0!3m2!1sar!2seg!4v1684770934286!5m2!1sar!2seg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row text-white g-4">
                <div class="col-md-6 col-lg-3">
                    <a class="text-uppercase text-decoration-none brand text-white" href="#"></a>
                    <p class="text-white text-muted mt-3">Maadi Corner is a newly growing online shop based on Maadi .
